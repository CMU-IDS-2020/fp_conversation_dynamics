...
disciplinary_2 = {'technology', 'iPod', 'Apple', 'player', 'Nest', 'products', 'sensor', 'learning', 'devices', \
                  ...
                  'iPhones', 'industry', 'installed', 'privacy', 'connected', 'transparency'}
...
def lengthMeasurer(lst):
    return len(set(lst[0])), len(set(lst[1])), len(set(lst[2]))
...
def createDictForJson(dic, dic1, dic2):
    ...
    listOfNodes.append({"id": "Maak", "group": 1, "colVal": 5})
...
# with open("sample20.json", "w") as outfile:
...
# with open("sample21.json", "w") as outfile:
